...
```
> cd goproject
> go get -d github.com/ethereum/go-ethereum  # 下载源码
> go install github.com/ethereum/go-ethereum/cmd/geth # 编译 安装源码

> tree bin  # 查看安装情况，默认也可以使用ls -l 查看
bin
└── geth
``` 
...
COMMANDS:
   account           管理账户相关命令，Ethereum分为合约账户和以太坊账户
...
#### 参考文档
[手把手教你搭建以太坊私有链](https://blog.csdn.net/sunshine1314/article/details/79692502)

```
    备注：个人Mac本，所以环境都是mac环境下，但基本东西都不易
```